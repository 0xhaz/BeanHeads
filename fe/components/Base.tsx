...
import { BgCircle } from "./misc/BGCircle";
...
import { FaceMask } from "./misc/FaceMask";
import { EyebrowProps } from "./eyebrows/types";
import { AccessoryProps } from "./accessories/types";

interface BaseProps {
  eyes: React.ComponentType<EyeProps>;
  eyebrows: React.ComponentType<EyebrowProps>;
  ...
  (
    ...
    return (
      <svg ref={ref} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 990">
        {/* {shape && <Mask id="mask-shape" />}
        {shape && <BgCircle circleColor={circleColor ?? "white"} />} */}
        {mask && <Mask id="mask" />}
