...
library OptItems {
    ...
    function isFaceMaskOn(Items memory items) internal pure returns (bool) {
        return items.faceMask == true;
    }

    function isMaskOn(Items memory items) internal pure returns (bool) {
        return items.mask == true;
    }

    function isLashesOn(Items memory items) internal pure returns (bool) {
        return items.lashes == true;
    }
