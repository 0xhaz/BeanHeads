...
library ClothingDetail {
    ...
    function dressFrontSVG() internal pure returns (string memory) {
        return string(
            abi.encodePacked(
                '<path d="M329.09,794.17c56.12,35.58,168.48,75.53,168.48,75.53l-.16,14S397,879.36,316.32,844.9C316.32,814.38,329.09,794.17,329.09,794.17Z" style="fill:#fff;stroke:#592d3d;stroke-miterlimit:10;stroke-width:12px"/>',
                '<path d="M648.66,870.5s17.7-1.85,30.9-9c-.11-4.25-.6-8.11-.6-8.11l-30.85,10.68Z" style="fill:#f2aa97"/>',
                '<path d="M671.55,794.43C619,831.8,503,869.7,503,869.7l.17,14s100.41-4.3,181.08-38.76C684.29,822.67,671.55,794.43,671.55,794.43Z" style="fill:#fff;stroke:#592d3d;stroke-miterlimit:10;stroke-width:12px"/>',
    ...
    function dressBackSVG() internal pure returns (string memory) {
        return string(
            abi.encodePacked(
                ...
                '<polygon points="632.74 831.31 609.95 869.4 621.34 999.43 632.94 999.43 632.94 893.78 632.74 831.31" style="fill:#e2e2e2"/>',
                '<path d="M380.53,1069.39H497.15c-109.2,0-100.91-231.14-129.89-231.14v217.87A13.27,13.27,0,0,0,380.53,1069.39Z" style="fill:#e2e2e2"/>',
        ...
        return SVGBody.fullSVG(
            ...
            string(
                abi.encodePacked(
                    ...
                    '<path d="M612.84,758.16c63.54,0,88.52,43.39,78.9,272-18.74,6.7-55.91,4.59-55.91,4.59Z" style="fill:#fff"/>',
                    '<polygon points="451.06 855.4 499.51 831.31 548.09 855.4 511.03 812.38 467.14 813.21 451.06 855.4" style="fill:#e2e2e2"/>',
                    '<path d="M635.63,831.31s-22.79,84.54-19.31,234l33.21-31,3.58-137.58C647.49,824.5,635.63,831.31,635.63,831.31Z" style="fill:#e2e2e2"/>',
                    '<path d="M389,758.16c-61.78,0-88.88,56.45-80.75,245.48,22.42,9.91,56.19,5.58,56.19,5.58Z" style="fill:#fff"/>',
                    '<path d="M306.94,957.49q.26,20.46,1.21,43.48c15.27.73,43.69.88,57.11,0l4.18-42.81C358.67,956.9,323.66,956.49,306.94,957.49Z" style="fill:#e2e2e2"/>',
                    '<path d="M370.12,831.31l-.5,177.69-13.35.9C353.3,860.85,370.12,831.31,370.12,831.31Z" style="fill:#e2e2e2"/>',
                    ...
                    '<path d="M372.6,1011.24c-1.83,2.61-73.77,1.92-74.67,0s-2.19-37.5,0-41c1.8-2.88,72.11-2.27,74.67,0S374.43,1008.63,372.6,1011.24Z" style="fill:#fff;stroke:#592d3d;stroke-linecap:square;stroke-miterlimit:10;stroke-width:12px"/>',
                    '<path d="M383.43,1069.39H500c-109.19,0-100.91-231.14-129.89-231.14v217.87A13.28,13.28,0,0,0,383.43,1069.39Z" style="fill:#e2e2e2"/>',
                    ...
                    '<path d="M697.42,970.24c2.22,2.26,1.59,38.39,0,41s-64,1.92-64.77,0-1.9-37.5,0-41c.27-.5,2.28-.89,5.45-1.18" style="fill:#fff;stroke:#592d3d;stroke-linecap:square;stroke-miterlimit:10;stroke-width:12px"/>',
                    '<path d="M678.92,968.3c3.8.3,15-1.18,15.42-.76" style="fill:#fff"/>',
                    ...
                    '<polygon points="592.51 763.64 517.84 818.45 559.98 852.83 619.4 763.59 592.51 763.64" style="fill:#e2e2e2"/>',
                    ...
                    '<polygon points="529.39 835.55 507.04 813.21 484.7 835.55 495.68 846.53 485.96 953.16 506.7 969.33 528.12 953.16 518.41 846.53 529.39 835.55" style="fill:#e2e2e2"/>',
                    ...
                    '<path d="M419.62,758.8s43.27,39.34,74.66,54.81C479,838.82,452.15,848,452.15,848l-59.43-89.23Z" style="fill:#fff;stroke:#592d3d;stroke-miterlimit:10;stroke-width:12px"/>',
                    '<path d="M580.38,758.8S541,800,505.72,813.61c10,20.28,42.13,34.37,42.13,34.37l59.43-89.23Z" style="fill:#fff;stroke:#592d3d;stroke-miterlimit:10;stroke-width:12px"/>',
                    ...
                    '<path d="M638.1,969.06c7.51-.71,21.51-.89,34-.67" style="fill:#fff"/>',
        ...
        return SVGBody.fullSVG(
            ...
            string(
                abi.encodePacked(
                    ...
                    '<path d="M610,758.72c63.54,0,73.4,56,73.9,133.17-18.6,11.62-48.91,1.31-48.91,1.31Z" style="fill:#fff"/>',
                    '<path d="M632.74,831.87,610,870l11.38,130h11.61V894.35l17.28,2.89C644.6,825.07,632.74,831.87,632.74,831.87Z" style="fill:#e2e2e2"/>',
                    '<path d="M386.12,758.72c-61.78,0-75.83,53.8-76.85,127.66,19,19.86,58,4.58,58,4.58Z" style="fill:#fff"/>',
                    '<path d="M367.23,831.87V891l-17.31,4.31C355.59,825.19,367.23,831.87,367.23,831.87Z" style="fill:#e2e2e2"/>',
                    ...
                    '<path d="M380.53,1070H497.15C388,1070,396.24,838.82,367.26,838.82v217.86A13.28,13.28,0,0,0,380.53,1070Z" style="fill:#e2e2e2"/>',
    ...
    function tankTopSVG() internal pure returns (string memory) {
        return SVGBody.fullSVG(
        ...
        return SVGBody.fullSVG(
            ...
            string(
                abi.encodePacked(
                    ...
                    '<path d="M616.66,758.16l-38.44.1c0,53.72-75.33,111.14-75.33,111.14s-80.8-60.58-80.8-111.14l-38.66-.1a13.28,13.28,0,0,0-13.28,13.27v284.69a13.28,13.28,0,0,0,13.28,13.27H622.36a13.27,13.27,0,0,0,13.27-13.27V778C635.63,765.82,629.75,758.16,616.66,758.16Z" style="fill:#fff"/>',
                    '<path d="M612.84,758.16c63.54,0,73.4,56,73.9,133.16-18.59,11.62-48.91,1.32-48.91,1.32Z" style="fill:#fff"/>',
                    '<path d="M635.63,831.31,612.84,869.4l11.39,130h11.6V893.78l17.28,2.89C647.49,824.5,635.63,831.31,635.63,831.31Z" style="fill:#e2e2e2"/>',
                    '<path d="M389,758.16c-61.78,0-75.82,53.79-76.85,127.66,19,19.85,57.95,4.58,57.95,4.58Z" style="fill:#fff"/>',
                    '<path d="M370.12,831.31V890.4l-17.31,4.3C358.48,824.63,370.12,831.31,370.12,831.31Z" style="fill:#e2e2e2"/>',
    ...
    function getClothingById(uint8 id) internal pure returns (Clothing memory) {
        if (id == 1) {
            return Clothing({name: DRESS, svg: dressSVG()});
        } else if (id == 2) {
            return Clothing({name: SHIRT, svg: shirtSVG()});
        } else if (id == 3) {
            return Clothing({name: TSHIRT, svg: tShirtSVG()});
        } else if (id == 4) {
            return Clothing({name: TANK_TOP, svg: tankTopSVG()});
        } else if (id == 5) {
            return Clothing({name: V_NECK, svg: vNeckSVG()});
        } else {
            revert ClothingDetail__InvalidClothingType();
        }
    }
}
