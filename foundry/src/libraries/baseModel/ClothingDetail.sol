...
library ClothingDetail {
    ...
    function getClothingById(uint8 id, uint8 color) internal pure returns (Clothing memory) {
        if (id == 1) {
            return Clothing({name: DRESS, svg: dressSVG(color)});
        } else if (id == 2) {
            return Clothing({name: SHIRT, svg: shirtSVG(color)});
        } else if (id == 3) {
            return Clothing({name: TSHIRT, svg: tShirtSVG(color)});
        } else if (id == 4) {
            return Clothing({name: TANK_TOP, svg: tankTopSVG(color)});
        } else if (id == 5) {
