...
library ClothingDetail {
    error ClothingDetail__InvalidColor(uint8 id);
    error ClothingDetail__InvalidType(uint8 id);
        ...
        returns (string memory svg, string memory name)
    {
        ...
        if (uint8(clothId) >= clothes.length) revert ClothingDetail__InvalidClothingType(uint8(clothId));
    ...
    function getClothingName(uint8 id) internal pure returns (string memory) {
        ...
        if (id >= clothes.length) revert ClothingDetail__InvalidType(uint8(clothId));
    ...
    function getClothingColor(uint8 id) internal pure returns (string memory) {
        ...
        if (id >= colors.length) revert ClothingDetail__InvalidColor(uint8(colorId));
        ...
        returns (string memory)
    {
        ...
        string memory breast = isWoman ? string(abi.encodePacked("<g>", BodyDetail.onlyBreastSVG(color), "</g>")) : "";

        return string(abi.encodePacked(s1, s2, s3, s4, breast));
    }
    ...
    function renderShirtSVG(bytes3 baseColor, bytes3 shadowColor, bool isWoman, uint8 color)
        ...
        returns (string memory)
    {
        string memory part1 = _shirtSVGPart1(baseColor, shadowColor);
        string memory part2 = _shirtSVGPart2(baseColor, shadowColor);
        string memory part3 = _shirtSVGPart3(baseColor, shadowColor);
        string memory breast = isWoman ? string(abi.encodePacked("<g>", BodyDetail.onlyBreastSVG(color), "</g>")) : "";
        return SVGBody.fullSVG(
            'id="shirt" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000"',
            string(abi.encodePacked(part1, part2, part3, breast))
        );
    }

    function _shirtSVGPart1(bytes3 baseColor, bytes3 shadowColor) private pure returns (string memory) {
        string memory baseHex = BytesConverter.bytesToHex(baseColor);
        string memory shadowHex = BytesConverter.bytesToHex(shadowColor);
    ...
    function _shirtSVGPart2(bytes3 baseColor, bytes3 shadowColor) private pure returns (string memory) {
        string memory shadowHex = BytesConverter.bytesToHex(shadowColor);
    ...
    function _shirtSVGPart3(bytes3 baseColor, bytes3 shadowColor) private pure returns (string memory) {
        string memory baseHex = BytesConverter.bytesToHex(baseColor);
        string memory shadowHex = BytesConverter.bytesToHex(shadowColor);
        ...
        returns (string memory)
    {
        ...
        return SVGBody.fullSVG(
            ...
            string(abi.encodePacked(s1, s2, s3, s4, s5, s6, s7, breast))
        );
    }
        ...
        returns (string memory)
    {
        ...
        return SVGBody.fullSVG(
            ...
            string(abi.encodePacked(s1, s2, s3, s4, breast))
        );
    }
    ...
    function _getColors(ClothColor color) private pure returns (bytes3, bytes3) {
        ...
        revert ClothingDetail__InvalidColor(uint8(color));
    }
}
