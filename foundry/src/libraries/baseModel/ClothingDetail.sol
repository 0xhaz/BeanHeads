...
library ClothingDetail {
    ...
    function getClothingById(uint8 id, uint8 color) internal pure returns (string memory) {
        if (id == 0) {
            return "";
        } else if (id == 1) {
            return dressSVG(color);
        } else if (id == 2) {
            return shirtSVG(color);
        } else if (id == 3) {
            return tShirtSVG(color);
        } else if (id == 4) {
            return tankTopSVG(color);
        } else if (id == 5) {
            return vNeckSVG(color);
        } else {
