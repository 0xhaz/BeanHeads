...
library BodyDetail {
    error BodyDetail__InvalidColor(uint8 id);
    error BodyDetail__InvalidType(uint8 id);
        ...
        returns (string memory svg, string memory name)
    {
        if (id == 1) {
            ...
            revert BodyDetail__InvalidType(id);
        }
    }
    ...
    function getBodyColorName(uint8 id) internal pure returns (string memory) {
        ...
        revert BodyDetail__InvalidColor(id);
    }
    ...
    function _getBreastColors(BreastColor color) private pure returns (bytes3, bytes3) {
        ...
        revert BodyDetail__InvalidColor(uint8(color));
    }
        ...
        returns (string memory)
    {
        return string(
            abi.encodePacked(
                _breastSVGPart1(skinBaseColor, skinShadowColor),
                _breastSVGPart2(skinBaseColor, skinShadowColor),
                _breastSVGPart3(baseColor, shadowColor),
                _breastSVGPart4(baseColor, shadowColor)
            )
        );
    }

    function _breastSVGPart1(bytes3 skinBaseColor, bytes3 skinShadowColor) private pure returns (string memory) {
        return string(
            abi.encodePacked(
                '<svg id="breast" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000">',
    ...
    function _breastSVGPart2(bytes3 skinBaseColor, bytes3 skinShadowColor) private pure returns (string memory) {
        return string(
            abi.encodePacked(
    ...
    function _breastSVGPart3(bytes3 baseColor, bytes3) private pure returns (string memory) {
        return string(
            abi.encodePacked(
                /// breast
                '<path d="M426.88,961.63a69.32,69.32,0,0,0,65.62-47,71,71,0,0,1-118.19,6.64L374.26,936C387,951.63,405.15,961.63,426.88,961.63Z" style="opacity:0.1"/>',
    ...
    function _breastSVGPart4(bytes3 baseColor, bytes3 shadowColor) private pure returns (string memory) {
        return string(
            abi.encodePacked(
    ...
    function renderChestSVG(bytes3 baseColor, bytes3 shadowColor) private pure returns (string memory) {
        return SVGBody.fullSVG(
            ...
            string(
                abi.encodePacked(
                    _chestSVGPart1(baseColor, shadowColor),
                    _chestSVGPart2(baseColor, shadowColor),
                    _chestSVGPart3(baseColor, shadowColor)
                )
            )
        );
    }

    function _chestSVGPart1(bytes3 baseColor, bytes3 shadowColor) private pure returns (string memory) {
        return string(
            abi.encodePacked(
                '<path d="M610,758.72c90.76,0,72,114.24,72.87,241.28H610Z" style="fill:',
                BytesConverter.bytesToHex(baseColor),
    ...
    function _chestSVGPart2(bytes3 baseColor, bytes3 shadowColor) private pure returns (string memory) {
        return string(
            abi.encodePacked(
    ...
    function _chestSVGPart3(bytes3, bytes3 shadowColor) private pure returns (string memory) {
        return string(
            abi.encodePacked(
                '<path d="M361.26,860.85c-.19-3.67-.11-7.34.05-11s.47-7.35.86-11c.2-1.84.4-3.67.65-5.51s.49-3.67.85-5.51a44.18,44.18,0,0,1,3.59-11,44.18,44.18,0,0,1,3.59,11c.36,1.84.62,3.67.85,5.51s.45,3.67.65,5.51c.38,3.67.68,7.34.85,11s.25,7.34.06,11Z" style="fill:#592d3d"/>',
                '<path d="M632.74,870v8c.26,34,.26,69,0,102.75,0,2.87,0,5.72,0,8.53v67.41A13.28,13.28,0,0,1,619.47,1070H380.53a13.28,13.28,0,0,1-13.27-13.28V998.52c0-2.51,0-5.07,0-7.65-.25-34.87-.25-69.87,0-105.3V860.85" style="fill:none;stroke:#592d3d;stroke-miterlimit:10;stroke-width:12px"/>',
