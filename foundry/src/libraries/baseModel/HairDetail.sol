...
library HairDetail {
    ...
    string constant AFRO_HAIR = "Afro Hair";
    string constant BALD_HAIR = "Bald Hair";
    string constant BOB_CUT_FRONT = "Bob Cut Front";
    string constant BOB_CUT_BACK = "Bob Cut Back";
    string constant BOB_CUT = "Bob Cut";
    string constant BUN_HAIR = "Bun Hair";
    string constant LONG_HAIR_FRONT = "Long Hair Front";
    string constant LONG_HAIR_BACK = "Long Hair Back";
    ...
    function afroBackSVG() internal pure returns (string memory) {
        return SVGBody.fullSVG(
            ...
            string(
                abi.encodePacked(
                    ...
                    '<path d="M741.2,386l-35,78.16,39.47,58.61c12.24-.91,18.61-2,17.31-3.17,28.2-3.57,50-28.11,50-57.87a60.75,60.75,0,0,0-.8-9.7C792.18,391.39,741.2,386,741.2,386Z" style="fill:#c65d28"/>',
    ...
    function afroFrontSVG() internal pure returns (string memory) {
        return SVGBody.fullSVG(
            ...
            string(
                abi.encodePacked(
                    ...
                    '<path d="M500.15,221.81C369,221.81,247.79,328.25,226,457c0,0,201.33,15.23,274.66-66.75-4.65,22.65-17.72,39.87-15.51,43.33,3.08,4.84,40.92-5.92,51.25-25.22l-3.66-5.48C582.65,421,680.23,443.46,746,375.26,702.52,285,604.61,221.81,500.15,221.81Z" style="fill:#d96e27"/>',
                    '<path d="M331.52,454.81a51.09,51.09,0,0,1-10.35-52.64,51.12,51.12,0,0,1-47.23-58.35c-24.09,33.69-41,72.3-48,113.18A671.08,671.08,0,0,0,331.52,454.81Z" style="fill:#c65d28"/>',
                    ...
                    '<path d="M310.23,580.89c-.93-.52-1.89-1-2.85-1.41C308.35,578.91,310.23,580.89,310.23,580.89Z" style="fill:none;stroke:#fff;stroke-miterlimit:10;stroke-width:12px"/>'
                )
            )
        );
    }
    ...
    function afroHairSVG() internal pure returns (string memory) {
        return SVGBody.fullSVG(
            'id="afro-hair" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000"',
            string(abi.encodePacked(afroBackSVG(), afroFrontSVG()))
        );
    }

    /// @dev SVG content for the "Bald Hair" hair type
    function baldHairSVG() internal pure returns (string memory) {
        return SVGBody.fullSVG(
            ...
            string(
                abi.encodePacked(
                    ...
                    '<path d="M871.11,500c-94.26-5.93-88.36-172.82-144.1-140.14h0l.42.69c-1.08,8.7-11.09,100.12,26.09,224.1.41-1.25.81-2.51,1.21-3.77,2,5.4,17,39.1,75.81,23.16-40.58-34.22-31.47-75.27-31.47-75.27S843.62,530.09,871.11,500Z" style="fill:#fff"/>',
                    ...
                    '<path d="M128.89,500c94.26-5.93,88.36-172.82,144.1-140.14h0l-.42.69c1.08,8.7,11.09,100.12-26.09,224.1-.41-1.25-.81-2.51-1.21-3.77-2,5.4-17,39.1-75.81,23.16,40.58-34.22,31.47-75.27,31.47-75.27S156.38,530.09,128.89,500Z" style="fill:#fff"/>',
    ...
    function bobCutFrontSVG() internal pure returns (string memory) {
        return SVGBody.fullSVG(
            'id="bob-cut-front" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000"',
            string(
                abi.encodePacked(
                    '<rect x="290.23" y="414.02" width="439.24" height="64.15" style="fill:#f2aa97"/>',
                    ...
                    '<path d="M284.48,462.85c.18-.75.33-1.32.53-1.94s.4-1.2.62-1.78c.46-1.17,1-2.31,1.51-3.42a48.48,48.48,0,0,1,3.85-6.42,37.51,37.51,0,0,1,4.88-5.75,17,17,0,0,1,7-4,31,31,0,0,1-.87,7.68c-.28,1.14-.59,2.25-.93,3.32l-1,3.25q-1,3.23-2,6.39c-.33,1.06-.68,2.09-1,3.13-.17.51-.37,1-.56,1.53s-.39,1-.56,1.4Z" style="fill:#592d3d"/>',
                    '<path d="M710.68,459.58a35,35,0,0,1,6.23.06,60.73,60.73,0,0,1,6.24.86c1,.2,2.08.4,3.12.64a25.74,25.74,0,0,1,3.11.86,18.53,18.53,0,0,1,6.24,3.58,18.74,18.74,0,0,1-6.24,3.59,25.68,25.68,0,0,1-3.11.85c-1,.25-2.08.45-3.12.65q-3.12.58-6.24.86a35,35,0,0,1-6.23.05Z" style="fill:#592d3d"/>',
                    '<path d="M444.84,452.07a134.88,134.88,0,0,1,1.49-14.25c.72-4.7,1.6-9.37,2.61-14s2.15-9.25,3.44-13.83A132.09,132.09,0,0,1,457,396.4a131.77,131.77,0,0,1-1.5,14.25q-1.08,7.05-2.61,14t-3.44,13.83A137,137,0,0,1,444.84,452.07Z" style="fill:#fff"/>',
                    '<path d="M668,452.07a134.88,134.88,0,0,1,1.49-14.25q1.09-7.05,2.61-14T675.49,410a132.09,132.09,0,0,1,4.57-13.58,131.76,131.76,0,0,1-1.49,14.25q-1.1,7.05-2.61,14c-1,4.64-2.16,9.25-3.45,13.83A134.48,134.48,0,0,1,668,452.07Z" style="fill:#fff"/>',
                    '<path d="M237.55,468.26a143,143,0,0,1,11.42-38" style="fill:#d86e27"/>',
                    ...
                    '<path d="M769.33,496s-.46-20.78-8.37-47.63" style="fill:#d86e27"/>',
    ...
    function bobCutBackSVG() internal pure returns (string memory) {
        return SVGBody.fullSVG(
    ...
    function bobCutSVG() internal pure returns (string memory) {
        return SVGBody.fullSVG(
            'id="bob-cut" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000"',
            string(abi.encodePacked(bobCutBackSVG(), bobCutFrontSVG()))
        );
    }

    /// @dev SVG content for the "Bun" hair type
    function bunHairSVG() internal pure returns (string memory) {
        return SVGBody.fullSVG(
            'id="bun-hair" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000"',
            string(
                abi.encodePacked(
                    '<circle cx="499.7" cy="170.67" r="107.58" style="fill:#d96e27"/>',
                    '<path d="M559.29,397.34c-12.87,24-60,37.44-63.83,31.42-4.3-6.73,37.84-55.32,13.9-106.14" style="fill:#f3ab98"/>',
                    '<path d="M719,353.29l-54.89,51.95c123.11,138.3,21.15,285.91,30.16,276a265.76,265.76,0,0,0,69-179C763.23,415.76,719,353.29,719,353.29Z" style="fill:#f3ab98"/>',
                    ...
                    '<path d="M409.8,229.76C429,259,435.67,233.25,498,233.25c107.21,0,73.62,25,92.69-5.15-27.59-9.65-44-19.39-88.13-19.39C460.26,208.71,438.69,219.05,409.8,229.76Z" style="fill:#c65d28"/>',
                    ...
                    '<path d="M677,396.19s-10.71-14.3-40.38-31" style="fill:#d96e27"/>',
    ...
    function longHairFrontSVG() internal pure returns (string memory) {
        return SVGBody.fullSVG(
    ...
    function longHairBackSVG() internal pure returns (string memory) {
        return SVGBody.fullSVG(
            'id="long-hair-back" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000"',
            string(
                abi.encodePacked(
                    '<rect x="200.88" y="510.35" width="601.66" height="306.44" style="fill:#592d3d"/>',
                    '<circle cx="501.71" cy="510.35" r="300.83" style="fill:#592d3d"/>',
                    '<circle cx="501.71" cy="816.78" r="300.83" style="fill:#592d3d"/>'
                )
            )
        );
    }
    ...
    function longHairSVG() internal pure returns (string memory) {
        return SVGBody.fullSVG(
            'id="long-hair" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000"',
            string(abi.encodePacked(longHairBackSVG(), longHairFrontSVG()))
        );
    }

    /// @dev SVG content for the "Pixie Cut" hair type
    function pixieCutSVG() internal pure returns (string memory) {
        return SVGBody.fullSVG(
            ...
            string(
                abi.encodePacked(
                    ...
                    '<path d="
                    '<path d="M444.84,452.07a132.29,132.29,0,0,1,1.49-14.25c.72-4.7,1.6-9.37,2.61-14s2.15-9.25,3.44-13.83A132.09,132.09,0,0,1,457,396.4a131.77,131.77,0,0,1-1.5,14.25q-1.08,7.05-2.61,14t-3.44,13.83A137,137,0,0,1,444.84,452.07Z" style="fill:#fff"/>',
                    '<path d="M668,452.07a134.88,134.88,0,0,1,1.49-14.25q1.09-7.05,2.61-14T675.49,410a132.09,132.09,0,0,1,4.57-13.58,131.76,131.76,0,0,1-1.49,14.25q-1.1,7.05-2.61,14c-1,4.64-2.16,9.25-3.45,13.83A134.48,134.48,0,0,1,668,452.07Z" style="fill:#fff"/>'
                )
            )
        );
    ...
    function shortHairSVG() internal pure returns (string memory) {
        return SVGBody.fullSVG(
            ...
            string(
                abi.encodePacked(
                    ...
                    '<path d="M260.74,460.82v-.06c17-.56,38.63-1.9,62.14-4.84,2.63-55.92,22-121.58,65.92-198.44h0L382,254.23A282.15,282.15,0,0,0,231.16,427.31c-13.86,11.92-26.86,20.34-27,25.69C203.89,462.92,243.47,462.36,260.74,460.82Z" style="fill:#c65d28"/>',
                    '<path d="M784,342.85c-5.1-5.1-31.06,1.83-57.19-.23A281,281,0,0,0,505.63,228.28c-2.44-20.48-.75-37.68-2.61-40.1-2.49-3.22-15.49,12.68-18.87,31-11.91-15-32.14-23-32.72-18.8-.38,2.68,7.44,14.09,14.81,29.9-111.6,13.47-203.08,92.26-235.08,197-13.86,11.92-26.86,20.34-27,25.69-.27,9.92,39.31,9.36,56.58,7.82v-.06c60.65-2,179-13.78,236.42-72.89C491.64,406.93,481.47,421,483.43,424c3,4.67,38.32-5.19,50.07-23.24,48,19.59,139.49,43.16,219-16.16l-.22-.43C766.77,372.06,790.35,349.25,784,342.85Z" style="fill:none;stroke:#592d3d;stroke-miterlimit:10;stroke-width:12px"/>',
                    '<path d="M505.93,244.31a367.42,367.42,0,0,0-42.48,4.94c-3.48.67-6.95,1.41-10.44,2.05s-6.9,1.61-10.35,2.41l-10.26,2.72c-3.4,1-6.77,2.08-10.15,3.12a314.12,314.12,0,0,0-39.43,15.73,348.31,348.31,0,0,0-37.25,21,183.85,183.85,0,0,1,35.08-25.14,219.23,219.23,0,0,1,39.76-17.29c3.48-1,6.94-2.09,10.42-3.05s7-1.82,10.55-2.6,7.1-1.4,10.66-2,7.15-1.07,10.73-1.52A190,190,0,0,1,505.93,244.31Z" style="fill:#fff"/>'
                )
            )
        );
    }
    ...
    function getHairDetailById(uint8 id) internal pure returns (Hair memory) {
        if (id == 1) {
            return Hair({name: AFRO_HAIR, svg: afroHairSVG()});
        } else if (id == 2) {
            return Hair({name: BALD_HAIR, svg: baldHairSVG()});
        } else if (id == 3) {
            return Hair({name: BOB_CUT, svg: bobCutSVG()});
        } else if (id == 4) {
            return Hair({name: BUN_HAIR, svg: bunHairSVG()});
        } else if (id == 5) {
            return Hair({name: LONG_HAIR, svg: longHairSVG()});
        } else if (id == 6) {
            return Hair({name: PIXIE_CUT, svg: pixieCutSVG()});
        } else if (id == 7) {
            return Hair({name: SHORT_HAIR, svg: shortHairSVG()});
        } else {
            revert HairDetail__InvalidHairType();
        }
    }
}
