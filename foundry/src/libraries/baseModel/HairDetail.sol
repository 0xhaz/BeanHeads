...
library HairDetail {
    ...
    /// @dev Converts bytes3 to a string for the SVG fill color
        ...
        return SVGBody.fullSVG(
            ...
            string(
                abi.encodePacked(
                    ...
                    '<path d="M444.84,452.07a134.88,134.88,0,0,1,1.49-14.25c.72-4.7,1.6-9.37,2.61-14s2.15-9.25,3.44-13.83A132.09,132.09,0,0,1,457,396.4a131.77,131.77,0,0,1-1.5,14.25q-1.08,7.05-2.61,14t-3.44,13.83A137,137,0,0,1,444.84,452.07Z" style="fill:#ffffff"/>',
                    '<path d="M668,452.07a134.88,134.88,0,0,1,1.49-14.25q1.09-7.05,2.61-14T675.49,410a132.09,132.09,0,0,1,4.57-13.58,131.76,131.76,0,0,1-1.49,14.25q-1.1,7.05-2.61,14c-1,4.64-2.16,9.25-3.45,13.83A134.48,134.48,0,0,1,668,452.07Z" style="fill:#ffffff"/>',
    ...
    function longHairSVG(uint8 id) internal pure returns (string memory) {
        return SVGBody.fullSVG(
            ...
            string(abi.encodePacked(longHairBackSVG(id), longHairFrontSVG(id)))
        );
    }
    ...
    function getHairDetailById(uint8 id, uint8 color) internal pure returns (Hair memory) {
        if (id == 1) {
            return Hair({name: AFRO_HAIR, svg: afroHairSVG(color)});
        } else if (id == 2) {
            return Hair({name: BALD_HAIR, svg: baldHairSVG(color)});
        } else if (id == 3) {
            return Hair({name: BOB_CUT, svg: bobCutSVG(color)});
        } else if (id == 4) {
            return Hair({name: BUN_HAIR, svg: bunHairSVG(color)});
        } else if (id == 5) {
            return Hair({name: LONG_HAIR, svg: longHairSVG(color)});
        } else if (id == 6) {
            return Hair({name: PIXIE_CUT, svg: pixieCutSVG(color)});
        } else if (id == 7) {
