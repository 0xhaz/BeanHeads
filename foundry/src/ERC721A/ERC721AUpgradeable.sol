...
/**
 * @title ERC721AUpgradeable Diamond
 * @dev ERC721A token with upgradeable capabilities.
 *
 * ERC721A Contracts adapted from ERC721A-Upgradeable Contracts v4.2.3 by Chiru Labs.
 */
import {ERC721AUpgradeableInternal, ERC721AStorage} from "src/ERC721A/ERC721AUpgradeableInternal.sol";
import {BHStorage} from "src/libraries/BHStorage.sol";

/**
 * @dev Interface for ERC721 token receivers
 */
...
contract ERC721AUpgradeable is ERC721AUpgradeableInternal {
    ...
    function transferFrom(address from, address to, uint256 tokenId) public payable virtual {
        ...
        // ownership above and the recippient's balance can't realistically overflow
        ...
        assembly {
            ...
            log4(
                ...
                _TRANSFER_EVENT_SIGNATURE, // Event signature
                from, // `from` address
                toMasked, // `to` address
                tokenId // `tokenId`
            )
